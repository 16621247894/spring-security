...
Mock.mock("/sys/userInfo", "get", () => {
    Result.data = {
        id: 1,
        username: 'test',
        avatar: 'https://www.baidu.com/link?url=5BEEdSIpsZdiUNcBq2r4WUsBOo0ZQ_j3icsclwm7FrCteK4M98DN7L0-0i1o8WiGq0DLZOyjL3rwmqj_FZmpGHJ2s4psq9ln9g5Pxx8dPqpE0TbKvoRa9zDYAEKJB0iGs4f2OjzL6f38ZBRYnS7iV97uk8hxrPnMckBz2MB3xZ2lYHCAw3GsDQyswhoGSnHzxSte68B3pSGitEiOH3z9ewbdHYZF_VK5Yzvw8rOjcc7KHI7KeGQ338tGE_9FqaRlsKoPn6V3fDt_1wt0etvfC_JCRncMuCufg34DIjLmX-2xn-i-2QuR1SFvuiTKK64O5EQ09zlbyQb988R0tK92YlhIhly3KJ-5sBu3k_-gU0hQoeUCxp5gInxs0yWzd1czf5p3rOKvNhW3uimrJiQqrhe5XDomUGPuIhc4RinsFiaERKXnsvaegtDwKpFkJ50Amx_cgYqYiZ3wfp1O0oWMpeUxnXpfF0C4R0b8Uwy5g6wBvgogVNUtJtZl6LKc08kBQZUCCcswjetlWCAYmevBnjgLTqexPIc_3fT0Js08ghAv8GieN5x65XCwsblvnlUa&wd=&eqid=dc82e1d5005e28930000000360eb00ab'
    }
    return Result;
})
// 修改用户信息
Mock.mock('/sys/user/updataPass', 'post', () => {
    return Result;
})
...
Mock.mock('/sys/menu/nav', 'get', () => {
    ...
    let nav = [
        ...
        },
        {
            ...
            component: '',
            children: [{
                name: 'SysDict', title: '数字字典', icon: 'el-icon-s-order', component: '',
                path: '/sys/dicts', children: []
            },]
        }
